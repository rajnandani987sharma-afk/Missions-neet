...
"<button onclick="checkAnswer('a')">${q.a}</button><br><br> <button onclick="checkAnswer('b')">${q.b}</button><br><br> <button onclick="checkAnswer('c')">${q.c}</button><br><br> <button onclick="checkAnswer('d')">${q.d}</button>"
}
